...
public class PncBuildConfigMojo extends AbstractMojo {
    ...
    private void configureDefaultRepoParams(final JsonNode repositoryGeneration) throws MojoExecutionException {
        ...
        final ProjectDependencyFilterConfig coreDepsToBuild = platformConfig.getCore().getDependenciesToBuild();
    ...
    private void addResolveArtifacts(final JsonNode parameters, final ProjectDependencyFilterConfig depsToBuild) {
